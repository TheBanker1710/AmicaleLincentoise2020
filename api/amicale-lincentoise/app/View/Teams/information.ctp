...
<div class="container" id="informationsEquipe">
    ...
    <table>
      ...
      ?>
        ...
        <tr>
          ...
          <td><?php echo $value['Team']['slug']; ?></td>
        </tr>
      <?php
      }
      ?>
    ...
    <table>
      ...
      <tbody>
        ...
        ?>   
          ...
          <tr><td colspan="6">Il n'y a pas de joueurs à afficher.</td></tr>
        <?php
        }else{
          $p = 1;
        ...
        <tr>   
          <td><?php echo $p; ?></td>       
          <td><?php echo $value['Player']['id']; ?></td>
  ...
  <div class="table">
    <table>
      <thead>
        <tr>
          <th width="30">Id journée</th>
          <th width="30">Id match</th>
          <th width="30">Type</th>
          <th width="60">Date</th>
  ...
  <div class="table">
    <table>
      ...
      ?>
      <tr>
        <td colspan="5">Il n'y pas de matchs à afficher.</td>
      </tr>
      <?php
        }
      ?>
