...
<html lang="fr">
  <head>
    ...
    <meta property="og:title" content="L'amicale lincentoise | <?= $this->fetch('title'); ?>">
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://mathieulancelle.be/amicale-lincentoise/">
    <meta property="og:image" content="http://mathieulancelle.be/amicale-lincentoise/img/facebook-share.jpg">
    ...
    <?= $this->fetch('css'); ?>
    <link rel="stylesheet" href="/amicale-lincentoise/js/bgrins-spectrum/spectrum.css"> 
    ...
    <?= $this->Html->script('bgrins-spectrum/spectrum.js'); ?>
    <?= $this->fetch('script'); ?>
          ...
          <li class="has-dropdown">
            ...
            <ul class="dropdown">
              ...
              <li>
                ...
                <i class="fa fa-file-pdf-o" aria-hidden="true"></i>  Règlement 2017-2018
               </a>
              </li>                 
              <li>
              ...
              <ul class="dropdown"> 
                  ...
                  <li>
                    <a href="<?php echo $this->Html->url(array(
                      ...
                      <i class="fa fa-list-ul"></i> Liste des journées
                    </a>
                  </li>                  
                  <li>
                    <a href="<?php echo $this->Html->url(array(
