...
<div class="container" id="days">
  ...
  <p>Saison <?php if(empty($days)){ echo "2016 - 2017"; }else{echo $days[0]['Season']['years'];} ?></p>
        ...
        <div class="day-result" id="day_<?php echo $days[0]['Day']['id']; ?>">           
          <div class="table">
            <table class="table-result-item">
              <thead>                
                <?php if($dayIndex['Day']['day_type'] == 2){ ?>
                  <tr>
                    <td colspan="5" class="last-day-head"><?php echo date_format(new \DateTime($dayIndex['Day']['date']),"d/m/Y"); ?></td>  
                  </tr>
                  <tr>    
                    <td colspan="5" class="last-day-head"><i class="fa fa-trophy" aria-hidden="true" style="margin-right: 3px;"></i> - Coupe - <?php echo $dayIndex['Cup']['name']; ?> </td>
                  </tr> 
                <?php }else{ ?> 
                  <tr>            
              ...
              ?>
              <tr class="<?php if($v['statut'] == 4 && $dayIndex['Day']['day_type'] == 2){ echo "hidden-cup"; }?>">
                <td colspan="5">
                <?php
                    if($v['statut'] == 1){
              ...
              <tr class="raw-result <?php if($v['statut'] == 4 && $dayIndex['Day']['day_type'] == 2){ echo "hidden-cup"; }?>">
               <td class="logo">
               <?php
                    if(empty($v['Team1'])){
                      echo ' ';
                ...
                <td class="game-time">            
                  <?php 
                    ...
                    if($v['score_team_home'] != null && $v['score_team_away'] != null){
                      ...
                      if($dayIndex['Day']['day_type'] == 2 && ($v['tab_home'] != null || $v['tab_away'] != null)){
